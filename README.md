...
3. **RF Breakout Board** (see laso: [RF Breakout Board](https://github.com/CnausAndreas/BLE_ESB/tree/main/hardware)):
    - **Key Components**:
...
This project is licensed under the MIT License. You can find the full license text in the [LICENSE](https://github.com/CnausAndreas/PiCAN_Sense/blob/main/docs/LICENSE) file.
